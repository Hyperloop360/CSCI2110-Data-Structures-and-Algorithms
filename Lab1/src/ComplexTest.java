...
public class ComplexTest {
    public static void main(String[] args) {
        ...
        System.out.println(z1 + (z1.isImaginary() ? " is a pure imaginary number" : " is NOT a pure imaginary number"));

        System.out.println();
        System.out.println("Number 2 is " + z2);
        System.out.println(z2 + (z2.isReal() ? " is a pure real number" : " is NOT a pure real number"));
        System.out.println(z2 + (z2.isImaginary() ? " is a pure imaginary number" : " is NOT a pure imaginary number"));
